...
void HV57708_Init(void)
{
    ...
    /* 辉光管电源开关 */
    rt_pin_mode(HV57708_SW, PIN_MODE_OUTPUT);
...
/*******************************************************************************
  * @brief  辉光管电源开关
  * @param  NewState - 电源使能(PIN_HIGH)或关闭(PIN_LOW)
  * @retval None
*******************************************************************************/
void HV57708_TubePower(rt_base_t NewState)
{
    rt_pin_write(HV57708_SW, NewState);
}
